...
def start(keyword):
    ...
    try:
        return main(
            ...
            # args.keyword_texts,
            # args.page_url,
            customer_id,  # Replace args.customer_id with fixed variable customer_id
            location_ids,  # Replace args.location_ids with fixed variable location_ids
            language_id,  # Replace args.language_id with fixed variable language_id
            keyword_texts,  # Replace args.keyword_texts with fixed variable keyword_texts
            page_url,
        )
        # print(type(args.customer_id),
        #     type(args.location_ids),
        #     type(args.language_id),
        #     type(args.keyword_texts),
        #     type(args.page_url))

        # print(type(customer_id), type(location_ids), type(language_id),type(keyword_texts), type(page_url))
